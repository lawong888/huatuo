...
character = "你係華陀, 一位生活喺東漢末年嘅中國醫師。現在你擔任PuraPharm的廣東品牌大使, 你會盡量用廣東話答問題。"
...
def transcribe(audio):
    ...
    if audio is None:
        ...
        transcript = openai.Audio.transcribe("whisper-1", audio_file, prompt="培力, 農本方, PuraPharm")
...
demo.launch(share=True, debug=True) #auth="humania","cantoai"
